...
ALTER TABLE /*_*/communityrequests_wishes
	RENAME TO /*_*/communityrequests_entities,
	RENAME COLUMN cr_type TO cr_wish_type;
ALTER TABLE /*_*/communityrequests_entities
	MODIFY cr_wish_type INT UNSIGNED DEFAULT NULL,
	MODIFY cr_actor BIGINT UNSIGNED DEFAULT NULL,
	ADD cr_entity_type TINYINT(1) DEFAULT 0 NOT NULL;
