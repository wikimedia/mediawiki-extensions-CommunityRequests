...
ALTER TABLE /*_*/communityrequests_wishes_translations
	RENAME TO /*_*/communityrequests_translations,
	RENAME COLUMN crt_wish TO crt_entity;
ALTER TABLE /*_*/communityrequests_translations
	DROP PRIMARY KEY,
	ADD PRIMARY KEY(crt_lang, crt_entity);
